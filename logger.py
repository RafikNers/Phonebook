...
def change_data():
    var_edit = int(input('Введите номер справочника, в который будем вносить изменеия: '))
...
def delete_data() :
    var_edit = int(input('Введите номер справочника, в которм нужно удалить запись: '))
